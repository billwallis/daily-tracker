...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            15,
            datetime.datetime.fromisoformat("2020-01-01 00:15:00"),
        ),
        (
            datetime.datetime.fromisoformat("2020-01-01 00:01:00"),
            15,
            datetime.datetime.fromisoformat("2020-01-01 00:15:00"),
        ),
        (
            datetime.datetime.fromisoformat("2020-01-01 00:51:00"),
            10,
            datetime.datetime.fromisoformat("2020-01-01 01:00:00"),
        ),
        (
            datetime.datetime.fromisoformat("2020-01-01 23:59:00"),
            1,
            datetime.datetime.fromisoformat("2020-01-02 00:00:00"),
        ),
        (
            datetime.datetime.fromisoformat("2020-01-01 00:10:00"),
            3,
            datetime.datetime.fromisoformat("2020-01-01 00:12:00"),
        ),
    ],
)
